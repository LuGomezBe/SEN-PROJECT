...
namespace ProyectoSen.Clases
{
...

    {
        ...
        public void guardarReporte(ComboBox Dni_T, TextBox Dni_C, TextBox Marca,TextBox estado)
        {
            try
            {
                CConexion objetoConexion = new CConexion();
        ...
        public void SelecionEstado(DataGridView tablaTecnico ,TextBox Id,TextBox estado)
        {
            try
            {
                Id.Text = tablaTecnico.CurrentRow.Cells[0].Value.ToString();
                estado.Text = tablaTecnico.CurrentRow.Cells[4].Value.ToString();
        ...
        public void UpdateEstado(TextBox Id,TextBox estado)
        {
            try
            {
                CConexion objetoConexion = new CConexion();
